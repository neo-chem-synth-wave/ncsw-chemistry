...
class ReactionFormattingUtility:
    ...
    def convert_reaction_rxn_to_smarts(
        ...
        if remove_compound_atom_map_numbers:
            reaction_rxn = ReactionCompoundUtility.remove_reaction_compound_atom_map_numbers(
    ...
    def convert_reaction_smarts_to_rxn(
        ...
        if remove_compound_atom_map_numbers and reaction_rxn is not None:
            return ReactionCompoundUtility.remove_reaction_compound_atom_map_numbers(
                reaction_rxn=reaction_rxn,
                deep_copy=False
            )
